...
We studied the effect of cone sizes on $\jt{}$ distribution with a \pythia~simulation. Distributions with different cone sizes in different \pt{,jet} bins are shown in Fig.~\ref{fig:RcomparisonjT}. The increase of high $\jt{}$ with increasing cone size, $R$, is clearly seen in the individual $\jt{}$ distributions. At low $\jt{}$ there is no change within the errors.
...
\begin{figure}[htp]
\centering
\includegraphics[width=0.95\textwidth]{figures/results/JetVsLeadingRefConst.pdf}

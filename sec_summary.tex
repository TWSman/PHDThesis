...
To constrain the effects from kinematical differences between \pt{,trigger} bins the analysis used bins of the fragmentation variable $\xlong$, which is the projection of the associated particle momentum $\vec p_a$ to the trigger particle momentum $\vec p_t$, normalised by the trigger particle momentum
...
%\includegraphics[width = 0.95\textwidth]{figures/summary/jtdistribution-89702.pdf}
%\end{subfigure}
%\begin{subfigure}{0.49\textwidth}

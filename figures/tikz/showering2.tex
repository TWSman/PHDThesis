...
hadron/.style={draw=red,line width=2pt,postaction={decorate},
    decoration={markings,mark=at position .9 with {\arrow[draw=red]{>}}}},
antiparticle/.style={draw=blue},
gluon/.style={decorate, draw=magenta, line width=0.75pt,
    decoration={coil,amplitude=4pt, segment length=5pt}}
 }
\begin{tikzpicture}
%\draw[step = 4cm, gray, thin] (-3cm,-3cm) grid(8,4cm);

\node[ellipse,draw=red,fill=red!20, minimum height=1cm, blur shadow = {shadow blur steps=5},minimum width=2cm] (hard) {};
...
\node[rectangle,draw=black, fill=red!20, below right=-0.5cm and 0cm of vertex3_1,minimum width=1cm, minimum height=6cm,label={below:Hadronisation},blur shadow = {shadow blur steps=5}] (hadr) {};

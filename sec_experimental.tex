...
\begin{figure}[tb]
\centering
\includegraphics[width=0.9\textwidth]{figures/CernCollidersSmall}
...
Additionally PS provides the beam to the Antiproton Decelerator, which collides the beam with a block of metal to produce antiprotons. These are then decelerated in the decelerator into a useful low-energy beam, which is provided to a host of experiments studying the properties of antimatter.
...
\centering
\includegraphics[width=0.95\textwidth]{figures/2012-Aug-02-ALICE_3D_v0_with_Text.jpg}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.95\textwidth]{figures/AliceITS}
...
\begin{figure}[htb]
\includegraphics[width=0.9\textwidth]{figures/EMCAL_components}
...
The L1 trigger can compare up to two thresholds for each single shower and jet trigger. There is a dedicated link in between the V0 detector and EMCal Summary Trigger Unit (STU), which can provide centrality information that is used to compute a dynamical threshold as a function of the V0 multiplicity~\cite{KRAL2012261}.
...
\subsection*{Quality Assurance of the GEM foils}

...
\coordinate[right=1cm of a] (vertex);
\coordinate[above right=0.5cm and 1 cm of vertex,label=right:$b$] (b);
\coordinate[below right=0.5cm and 1 cm of vertex,label=right:$c$] (c);
...
We still need to consider soft gluon enhancement~{\color{red} reword}. Fig.~\ref{fig:soft} shows a case where a gluon splits into two quarks, and one of the created quarks emits a soft gluon. In the laboratory frame the time it takes for a gluon to be emitted from a quark can be estimated to be
...
\coordinate[label=left:$a$] (a);
\coordinate[right=1cm of a] (vertex);
\coordinate[above right = 0.25cm and 0.5cm of vertex] (vertex2);
\coordinate[above right=0.5cm and 0.5cm of vertex2] (gluon);
\coordinate[above right=0.5cm and 1 cm of vertex,label=right:$b$] (b);
\coordinate[below right=0.5cm and 1 cm of vertex,label=right:$c$] (c);
\draw[gluon] (a) -- (vertex);
\draw[particlearrow] (vertex) -- node[label=above:$z$] {$q$} (b);
\draw[particlearrow] (vertex) -- node[label=below:$1-z$] {$\bar q$} (c);

...
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\begin{overpic}[abs,unit=1mm,scale=.30]{figures/analysis/JetPtResponse.pdf}
\put(10,0){\color{white}\polygon*(50,0)(50,6.5)(10,6.5)(10,0)}
\put(30,0){\color{black}$\pt{,obs} (\gevc)$}
\put(0,20){\color{white}\polygon*(0,25)(6.5,25)(6.5,10)(0,10)}
\put(0,20){\rotatebox{90}{$\pt{,true} (\gevc)$}}

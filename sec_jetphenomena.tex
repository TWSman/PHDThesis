...
(diagonal lines are (anti)quarks, horizontal ones snapshots of the string field). Figure from \cite{eventGenerators}.
 }
 %Permission needed
\label{fig:fluxtube}
\end{figure}
...
\caption[]{ Colour structure of a parton shower to leading order in $N_c$. Figure from

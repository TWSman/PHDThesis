...
%\begin{figure}[htb]
%\centering
%\includegraphics[width=0.5\textwidth]{figures/QCDLO}
...
%\includegraphics[width=0.5\textwidth]{figures/ink}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.9\textwidth]{figures/Showering}
...
%\includegraphics[height=2in]{figures/BremsstrahlungElectron}

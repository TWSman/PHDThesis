...
\begin{figure}[b!]
\centering
            	\includegraphics[width=0.9\textwidth]{figures/figure_ridges}
...
\centering
		...
		\includegraphics[width=0.65\textwidth]{figures/41567_2018_360_Fig4_HTML.png}
...
\begin{figure}[b!]
\centering
            	\includegraphics[width=0.9\textwidth]{figures/figure_ppb_jetquenching.pdf}
...
\begin{figure}[b!]
\centering
            	\includegraphics[width=0.750\textwidth]{figures/CentralitypPb}
...
\begin{figure}[tbp]
\centering
            	\includegraphics[width=0.7\textwidth]{figures/BNpart_Glau-10758.pdf}
            	\includegraphics[width=0.7\textwidth]{figures/NpartMult_Glau-10759.pdf}
